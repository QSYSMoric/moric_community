<template>
  <Waterfall :list="list" class="bg-[--v-theme-surface-light]! pa-0" :hasAroundGutter="false" :crossOrigin="false"
    :breakpoints="{
      1920: { rowPerView: 4 },
      1200: { rowPerView: 3 },
      960: { rowPerView: 2 },
      600: { rowPerView: 1 },
    }" align="left" :gutter="16">
    <template #item="{ item }">
      <v-card class="card" hover>
        ...
        <v-card-item>
          ...
          <v-card-actions class="pa-0">
            <v-avatar :size="26">
              <v-img :src="getFileUrl(item.publisher.avatart)
                ">
              </v-img>
            </v-avatar>
